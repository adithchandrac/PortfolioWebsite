...
export default function About() {
  return (
    <section id="about" className="py-16 max-w-2xl mx-auto pb-10">
...
I’ve interned at KPMG, Palantir, and Amalgam Inc., working on generative AI, large-scale data applications, and fullstack development using modern frameworks like React.js, Next.js, and Angular. As a co-founder and product manager at WallStreetEdge, I led the creation of an AI tutor web app, managing both technical and strategic aspects.
